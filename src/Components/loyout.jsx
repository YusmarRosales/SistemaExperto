  ...
  const establecerMensajeFinal = () => {
    ...
    if (!algunaRespuestaSi) {
      ...
      if (grupoActual === "Fisica") {
        setMensajeFinal("¡NO ESTAS SOLA! Estas corriendo PELIGRO ten cuidado ESTAS SUFRIENDO VIOLENCIA FISICA. Acércate a nuestras instalaciones para darte brindarte información sobre tus derechos, cómo obtener protección y cómo recuperarte del abuso, el Instituto tachirense de la Mujer (INTAMUJER) te ofrecerá ayuda.");
      } else if (grupoActual === "Economica") {
        setMensajeFinal("¡NO ESTAS SOLA! Estas sufriendo de maltrato ECONOMICO ten cuidado porque esto se puede agravar. Acércate a nuestras instalaciones para darte brindarte información sobre tus derechos, cómo obtener protección y cómo recuperarte del abuso, el Instituto tachirense de la Mujer (INTAMUJER) te ofrecerá ayuda.");
